...
export const BluetoothIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.115 5.115a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v13.5a.75.75 0 01-1.5 0v-6.39l-2.122 2.121a.75.75 0 01-1.06 0l-.88-  .879a.75.75 0 010-1.061l2.121-2.121v-2.88a.75.75 0 01.75-.75zM12.75 5.115a.75.75 0 01.75-.75h1.5a.75.75 0 01.75.75v13.5a.75.75 0 01-1.5 0v-6.39l-2.122 2.121a.75.75 0 01-1.06 0l-.88-.879a.75.75 0 010-1.061l2.121-2.121v-2.88a.75.75 0 01.75-.75z" />
  </svg>
);
...
export const HeadphonesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M4.886 5.636a9 9 0 0112.728 0M12 20.25v-7.5m0 0V5.636m0 7.114H6.886m5.114 0h5.114" />
    </svg>
);

export const SpeakerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M12 20.25a9 9 0 01-7.114-14.614m7.114 14.614A9 9 0 0019.114 5.636m-7.114 14.614v-7.5a2.25 2.25 0 00-2.25-2.25H7.5a2.25 2.25 0 00-2.25 2.25v7.5m3-7.5h.008v.008H10.5v-.008zM10.5 12a2.25 2.25 0 114.5 0 2.25 2.25 0 01-4.5 0zM13.5 12h.008v.008H13.5v-.008z" />
    </svg>
);
...
export const MouseIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
